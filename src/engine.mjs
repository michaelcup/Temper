...
export function enginePrompt(plan, violations) {
  ...
  p += 'Edit ONLY the files/globs listed above. If completing the task correctly requires changing a file '
  p += 'OUTSIDE that list, do NOT edit it: make the in-scope changes you can, then state plainly which '
  p += 'out-of-scope file blocks completion so the human can widen the scope. Editing outside the list is '
  p += 'rejected and wastes the attempt.\n'
